//conta le rioccorrenze di un char in una stringa e scrivile in un array grande il minimo possibile
//(prima funz ric per calcolare la dim da allocare e seconda funz ric che inserisce i dati)
